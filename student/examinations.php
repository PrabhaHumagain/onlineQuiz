                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>Quiz Player</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a class="btn btn-success" href="take-assessment.php?id='.$row['exam_id'].'">Start Quiz</a>';
											   }else{
											   $st = '<p class="text-danger">INACTIVE</p>';
                                               $stl = '<a class="btn btn-danger disabled" href="#">Start Quiz</a>';
											   }
                                          print '
										       <tr>
                                                <td>'.$row['exam_name'].'</td>
