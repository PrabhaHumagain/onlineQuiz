                ...
                <div id="main-wrapper">
                    <div class="row col-md-12">
                        <div class="col-md-6">
                           ...
                           <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Quiz Properties</h4>
                                </div>
						...
						<div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Play Quiz</h3>
                                </div>
                                <div class="panel-body">
								<?php
								if ($record_found == "1") {
								...
								print '
                                 <div class="alert alert-success" role="alert">
                                  You are good to go.
									...
									'; ?>
									<a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="assessment.php">Replay Quiz</a>
                                ...
                                print '
								<div class="alert alert-warning" role="alert">
                                You will be able to retake this Quiz on '.$retake_date.'
                                </div>';
								}
								...
								print '
                                 <div class="alert alert-success" role="alert">
                                  You are good to go.
									...
									'; ?>
									<a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="assessment.php">Start Quiz</a>
